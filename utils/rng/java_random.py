...
class JavaRandom:
	...
	nextDouble = next_double  # noqa: N815
	nextLong = next_long  # noqa: N815
	nextFloat = next_float  # noqa: N815
...
def find_seed(x, y, n=32, m=32):
	...
	for old_seed in range(
		old_seed_upper_n, (old_seed_upper_n | ((1 << (48 - n)) - 1)) + 1
	):
